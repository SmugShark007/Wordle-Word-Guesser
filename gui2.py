...
class WordleSolverGUI:
    ...
    def _setup_styles(self):
        style = ttk.Style()
        style.configure(".", background="#F5F5F5")  # Light gray background
        
        # Professional notebook and tab styles
        ...
        style.map("TNotebook.Tab",
                 background=[("selected", "#FFFFFF"), ("!selected", "#E0E0E0"), ("active", "#F0F0F0")],
                 foreground=[("selected", "#2C3E50"), ("!selected", "#5D6D7E"), ("active", "#2C3E50")])
        ...
        style.map("Vertical.TScrollbar",
                  background=[("active", "#CCCCCC"), ("disabled", "#E0E0E0")])
    ...
    def create_widgets(self):
        ...
        compare_button = tk.Button(button_frame,
                                   ...
                                   bg="#34495E",  # Professional dark blue
                                   activebackground="#2C3E50",  # Darker blue on hover
        ...
        clear_button = tk.Button(button_frame,
                                 ...
                                 font=("Arial", 11, "bold"),
                                 fg="#FFFFFF",  # White text
                                 bg="#95A5A6",  # Professional gray
                                 activebackground="#7F8C8D",  # Darker gray on hover
                                 activeforeground="#FFFFFF",  # White text on hover
                                 relief="flat",
                                 padx=15,
                                 pady=8)
